...
* **Questão 1:** identificação de PID e PPID.  
* **Questão 2:** árvore de processos.  
* **Questão 3:** estado do processo.  
* **Questão 4:** utilização de CPU e memória.  
* **Questão 5:** prioridade e valor nice.  
* **Questão 6:** identificação de threads.  
...
Os comandos usados durante a atividade estão em:
